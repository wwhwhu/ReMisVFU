...
if __name__ == "__main__":
    ...
    with open(f'./res/{dataset_name}/retrain/vfl_training_log.csv', 'w') as f:
    ...
    for i in range(epoch):        
        ...
        for _ in tqdm(range(num_batches), desc="Training Batches"):
            ...
            for p, it in enumerate(loaders_iter):
                ...
                _, y_ref = add_trigger_to_right(
                    ...
                    poison_fraction=poison_fraction  # 只有 target_party 中毒
                )
        ...
        # -------- 保存日志 --------
        with open(f'./res/{dataset_name}/retrain/vfl_training_log.csv', 'a') as f:
        ...
        if test_acc > best_acc:
            ...
            torch.save(ckpt, f"./res/{dataset_name}/retrain/vfl_best_model.pth")
